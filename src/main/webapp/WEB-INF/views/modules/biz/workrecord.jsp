...
<body class="easyui-layout layui-anim layui-anim-scale" border=false>
			...
			<div region="center" border=false style="padding: 0 10px 10px 10px">
				<table id="grid">
					<thead>
						<tr>
						    <th data-options="field:'djbh',width:100,align:'center',halign:'center'">单据编号</th>
							<th data-options="field:'djrq',width:100,align:'center',halign:'center',formatter:dgDate">日期</th>
							<th data-options="field:'lb',width:60,align:'center',halign:'center'">类别</th>
							<th data-options="field:'xxmc',width:250,align:'left',halign:'center'">学校名称</th>
		...
		<script type="text/javascript">
			...
			function setJobContent(rows){
				$('#ifrmFloatEditDiv')[0].contentWindow.setJobContent(rows);
			}
			function getChecked() {
