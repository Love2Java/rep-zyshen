...
public class SystemService extends BaseService implements InitializingBean {
	 ...
	 * @return
	 */
	public List<Role> getRoleList(int pageNo, int pageSize, Role role){
		return roleDao.getRoleList(new RowBounds(pageSize*(pageNo-1), pageSize), role);
	}
	/**
	 * 查询所有角色count
	 * @return
	 ...
	 * @return
	 */
	public List<User> getUserList(int pageNo, int pageSize, User user){
		return userDao.getUserList(new RowBounds(pageSize*(pageNo-1), pageSize), user);
	}
	/**
	 * 查询所有用户count
	 * @return
	...
	public List<User> getUserRoleList(int pageNo, int pageSize, User user){
		return userDao.getUserRoleList(new RowBounds(pageSize*(pageNo-1), pageSize), user);
	}
	public int getUserRoleListCount(User user){
		return userDao.getUserRoleListCount(user);
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<Menu> findByRoleId(Role role) {
		return menuDao.findByRoleId(role);
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	@Transactional(readOnly = false)
	public void updateMenuShow(Menu menu) {
		menuDao.updateShow(menu);
		// 清除用户菜单缓存
		UserUtils.removeCache(UserUtils.CACHE_MENU_LIST);
//		// 清除权限缓存
//		systemRealm.clearAllCachedAuthorizationInfo();
