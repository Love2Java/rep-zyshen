...
public class User extends DataEntity<User> {
	...
	private String lssfzh;//临时身份证号
	private String csrq;//出生日期 YYYY-MM-dd
	private String xjzdz;//现住所地址
	private String qq;//QQ
	private String wxh;//微信
	...
	private String xxmc;
	private String hy;//婚姻(已婚、未婚、离婚、丧偶)
	private String hymc;
	private String cylb;//从业类别
	private String cylbmc;
	private String cyrq;//从业日期YYYY-MM-dd
	...
	public String getLssfzh() {
		return lssfzh;
	}

	public void setLssfzh(String lssfzh) {
		this.lssfzh = lssfzh;
	}
	...
	public String getCylbmc() {
		return cylbmc;
	}

	public void setCylbmc(String cylbmc) {
		this.cylbmc = cylbmc;
	}
